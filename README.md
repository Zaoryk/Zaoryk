...
![WampServer](https://img.shields.io/badge/-WampServer-FF4088?style=flat&logo=wampserver&logoColor=white)
...
- **Web Frameworks:** HTML, CSS, Node.js, React, Django, WampServer, phpMyAdmin  
- **Databases:** MySQL, MongoDB  
- **Infrastructure / Tools:** Git, Docker, VirtualBox, AWS  
- **Operating Systems:** Linux (Arch, Mint, Fedora, Ubuntu, Ubuntu Server), Windows Server  
- **Security & Networking:** Wireshark, Nmap, Burp Suite, Metasploit, Kali Linux  
